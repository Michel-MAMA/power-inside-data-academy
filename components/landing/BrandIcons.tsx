/**
 * Icônes de marque en SVG inline (tracés Tabler Icons).
 * lucide-react a déprécié/retiré ses icônes de marque — on ne dépend
 * d'aucune version pour LinkedIn, GitHub, YouTube et X.
 */
...
export function XTwitterIcon({ size = 17, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.9" strokeLinecap="round" strokeLinejoin="round" className={className} aria-hidden>
